...
$( document ).ready(function() {
  var template = $('#cite-btn-template').html();
  $('.cite-btn-container').html(template);
});
...
function citeButtonClick(elem){
  var parent = elem.parentNode.parentNode;
  var cite = parent.parentNode.getElementsByClassName("cite-text")[0];
  var cross = parent.getElementsByClassName("cite-btn-cross")[0];
  if (cite.style["max-height"] != "1000px") {
    cite.style["max-height"] = "1000px";
    cite.style["margin-top"] = "1.5rem";
    cite.style["margin-bottom"] = "3rem";
    cite.style.opacity = "1";
    cross.style["transform"] = "rotate(-45deg)";
  } else {
    cite.style["max-height"] = "0px";
    cite.style["margin-top"] = "0rem";
    cite.style["margin-bottom"] = "0rem";
